...
export const TestUsers: { [key: string]: TestUser} = {
  John: {
    ...
    group_id: 'j6HNjFlgrcvT6DxWlGXOyAXAkn1KlXE3' as Entity.Id,
  ...
  Dave: {
    ...
    group_id: 'giD6GA6qb0ERekZ1H7mY1J0a7V1aW1gQ' as Entity.Id,
  ...
  Heidi: {
    ...
    group_id: 'xCi6nc3wEroRElKKvknZWgGxxTyN8Hxn' as Entity.Id,
