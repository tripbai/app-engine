...
import { StoreIndexer } from "./app/stores/event-listeners/store-indexer";
...
import { JSONFileHelper } from "./core/providers/database/jsonfiledb/jsonfile-helper";
...
import { GenericErrorMessage } from "./core/router/generic-error-message";
import { HttpRouterAdapter } from "./core/router/http-router-adapter";
...
import { ProfileImageUploadService } from "./identity-authority/profiles/services/profile-image-upload.service";
...
import { UserConstraintService } from "./identity-authority/users/services/user-constraint.service";
...
export const bind = (container: Container) => {
  ...
  container.bind(StoreIndexer).toSelf();
  ...
  container.bind(JSONFileDB).toSelf();
  container.bind(JSONFileHelper).toSelf();
  ...
  container.bind(GenericErrorMessage).toSelf();
  container.bind(HttpRouterAdapter).toSelf();
  ...
  container.bind(KryptodocEnvConfig).toSelf();
  ...
  container.bind(ProfileImageUploadService).toSelf();
  ...
  container.bind(UserConstraintService).toSelf();
