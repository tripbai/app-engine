...
export class UpdateTenantController {
  ...
  constructor(
    @inject(UpdateTenantCommand) private readonly updateTenantCommand: UpdateTenantCommand
  ) {}
  
  @patch<IdentityAuthority.Tenants.Endpoints.UpdateTenant>('/identity-authority/tenants/:tenant_id')
  async updateTenant<T extends IdentityAuthority.Tenants.Endpoints.UpdateTenant>(
