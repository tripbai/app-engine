...
import { BadRequestException, LogicException, ResourceAccessForbiddenException } from "../../../core/exceptions/exceptions";
...
export class GetTenantController {
  ...
  @get<IdentityAuthority.Tenants.Endpoints.GetTenant>('/identity-authority/tenants/:tenant_id')
  async getTenantData<T extends IdentityAuthority.Tenants.Endpoints.GetTenant>(
    ...
    const tenantModel = await this.tenantRepository.getById(params.data.tenant_id)
    return {
