...
describe("IAuthRequester", () => {
  describe("hasAllowedAccess()", () => {
    ...
    it("should return false for requesters with not allowed access", () => {
      ...
      bind_provider(container);
      const iauthRequesterFactory = container.get(IAuthRequesterFactory);
      const archivedRequester = iauthRequesterFactory.create(
        new BaseRequester({
      ...
      const bannedRequester = iauthRequesterFactory.create(
        new BaseRequester({
      ...
      const deactivatedRequester = iauthRequesterFactory.create(
        new BaseRequester({
      ...
      const suspendedRequester = iauthRequesterFactory.create(
        new BaseRequester({
    ...
    it("should return true for requesters with allowed access", () => {
      ...
      bind_provider(container);
      const iauthRequesterFactory = container.get(IAuthRequesterFactory);
      const activeRequester = iauthRequesterFactory.create(
        new BaseRequester({
      ...
      const unverifiedRequester = iauthRequesterFactory.create(
        new BaseRequester({
