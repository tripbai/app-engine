...
export class UserStatusService {
  ...
  banUser(iAuthRequester: IAuthRequester, userModel: UserModel) {
  ...
  deactivateUser(iAuthRequester: IAuthRequester, userModel: UserModel) {
  ...
  reactivateUser(iAuthRequester: IAuthRequester, userModel: UserModel) {
    if (userModel.status === "active" || userModel.status === "unverified") {
      throw new RecordAlreadyExistsException({
  ...
  archiveUser(iAuthRequester: IAuthRequester, userModel: UserModel) {
    ...
    userModel.archived_at = getTimestampNow();
  }
}
