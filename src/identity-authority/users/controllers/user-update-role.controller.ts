...
export class UserUpdateRoleController {
  ...
  constructor(
    ...
    @inject(UpdateUserRoleCommand) public readonly updateUserRoleCommand: UpdateUserRoleCommand
  ) {}

  @post<IdentityAuthority.Users.Endpoints.UpdateUserRole>('/identity-authority/user/delegate/role')
  async updateRole<T extends IdentityAuthority.Users.Endpoints.UpdateUserRole>(
    ...
    await this.updateUserRoleCommand.execute(
