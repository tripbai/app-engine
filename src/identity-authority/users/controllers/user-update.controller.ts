...
export class UserUpdateController {
  ...
  async updateUserModel<T extends IdentityAuthority.Users.Endpoints.UpdateUser>(
    ...
    const commandParams: Parameters<UpdateUserCommand['execute']>[2] = Object.create(null)
    ...
    try {
      ...
      if (
        ...
        if (
          ...
          commandParams.password = {
            reset_confirmation_token: params.data.password.reset_confirmation_token,
          ...
          this.userAssertions.isRawPassword(params.data.password.current_password) 
          commandParams.password = {
      ...
      if (
        ...
        typeof params.data.username === 'string'
      ) {
      ...
      if (
        ...
        commandParams.email_address = {
          update_confirmation_token: params.data.email_address.update_confirmation_token
        }
      }
      ...
      if (
        ...
        typeof params.data.is_email_verified.verification_confirmation_token === 'string'
      ) {
        params.data.is_email_verified.verification_confirmation_token
        commandParams.is_email_verified = {
          verification_confirmation_token: params.data.is_email_verified.verification_confirmation_token
        }
      }
