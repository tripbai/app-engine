...
export class UserAccessReportController {
  ...
  constructor(
    @inject(UserAccessReportService) public readonly userAccessReportService: UserAccessReportService,
    @inject(UserAssertions) public readonly userAssertions: UserAssertions
  ){}

  @post<IdentityAuthority.Users.Endpoints.AccessReport>('/identity-authority/access-report')
  async createAccess<T extends IdentityAuthority.Users.Endpoints.AccessReport>(params: Core.Route.ControllerDTO<T>): Promise<T['response']>{
