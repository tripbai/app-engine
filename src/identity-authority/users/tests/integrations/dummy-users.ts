...
const createPasswordHash = (password: string) => {
  ...
  return userPasswordService.hashPassword(
...
export const getJohnUserModel = async () => {
  const John: UserModel = {
    ...
    email_address:
      "john@example.com" as IdentityAuthority.Users.Fields.UniqueEmailAddress,
...
export const getKyleUserModel = async () => {
  const Kyle: UserModel = {
    ...
    identity_provider: "iauth",
    email_address:
      "kyle@example.com" as IdentityAuthority.Users.Fields.UniqueEmailAddress,
...
export const getLaraUserModel = async () => {
  const Lara: UserModel = {
    ...
    identity_provider: "iauth",
    email_address:
      "lara@example.com" as IdentityAuthority.Users.Fields.UniqueEmailAddress,
...
export const getMiguelUserModel = async () => {
  const Miguel: UserModel = {
    ...
    identity_provider: "iauth",
    email_address:
      "miguel@example.com" as IdentityAuthority.Users.Fields.UniqueEmailAddress,
...
export const getEmilyUserModel = async () => {
  const Emily: UserModel = {
    ...
    identity_provider: "iauth",
    email_address:
      "emily@example.com" as IdentityAuthority.Users.Fields.UniqueEmailAddress,
...
export const getNoahUserModel = async () => {
  const Noah: UserModel = {
    ...
    identity_provider: "iauth",
    email_address:
      "noah@example.com" as IdentityAuthority.Users.Fields.UniqueEmailAddress,
...
export const getWebAdminUserModel = async () => {
  const WebAdmin: UserModel = {
    ...
    identity_provider: "iauth",
    email_address:
      "webadmin@example.com" as IdentityAuthority.Users.Fields.UniqueEmailAddress,
...
export const getAnthonyFromFireAuthUserModel = async () => {
  const AnthonyFromFireAuth: UserModel = {
    ...
    email_address:
      "anthonyfireauth@example.com" as IdentityAuthority.Users.Fields.UniqueEmailAddress,
    username:
      "anthonyfireauth" as IdentityAuthority.Users.Fields.UniqueUsername,
    is_email_verified: true,
    verified_since: "2024-12-01 11:23:21",
    suspended_until: null,
    creation_context: "external",
...
export const getLucyFromGoogleUserModel = async () => {
  const AnthonyFromFireAuth: UserModel = {
    ...
    email_address:
      "lucygoogle@example.com" as IdentityAuthority.Users.Fields.UniqueEmailAddress,
