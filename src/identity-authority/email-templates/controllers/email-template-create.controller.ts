...
export class EmailTemplateCreateController {
  ...
  constructor(
    @inject(CreateEmailTeamplateCommand) public readonly createEmailTeamplateCommand: CreateEmailTeamplateCommand
  ){}
  
  @post<IdentityAuthority.EmailTemplatesRegistry.Endpoints.Create>('/identity-authority/registry/email-templates')
  async registerEmailTemplate<T extends IdentityAuthority.EmailTemplatesRegistry.Endpoints.Create>(
