...
export class EmailTemplateUpdateController {
  ...
  constructor(
    @inject(UpdateEmailTemplateCommand) public readonly emailTemplateUpdateService: UpdateEmailTemplateCommand
  ){}
  
  @patch<IdentityAuthority.EmailTemplatesRegistry.Endpoints.Update>('/identity-authority/registry/email-templates/:entity_id')
  async updateEmailTemplate<T extends IdentityAuthority.EmailTemplatesRegistry.Endpoints.Update>(
