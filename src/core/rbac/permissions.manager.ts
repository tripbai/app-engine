...
export class PermissionManager {
   ...
   */
  satisfies(
    assignedPermissions:Array<Core.RBAC.ConcretePermissionToken>,
    requiredPermission:Core.RBAC.ConcretePermissionToken
  ): boolean {
   ...
   */
  populate(
    permission: Core.RBAC.AbstractPermissionToken,
    data: { [key: string]: any }
  ): Core.RBAC.ConcretePermissionToken {
