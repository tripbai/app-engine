export namespace Core {
  ...
  export namespace Entity {
    ...
    export type ReservedFields = 'id' | 'entity_id' | 'created_at' | 'updated_at' | 'archived_at';
  }
  ...
  export namespace RBAC {
     ...
     */
    export type AbstractPermissionToken = string & {
      delimiter: ":";
      placeholders: true;
    };
     ...
     * user:sampleuserid
     */
    export type ConcretePermissionToken = string & {
      delimiter: ":";
      placeholders: false;
    };
