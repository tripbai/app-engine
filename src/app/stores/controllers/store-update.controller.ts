...
export class StoreUpdateController {
  ...
  constructor(
    @inject(UpdateStoreCommand) public readonly updateStoreCommand: UpdateStoreCommand
  ) {}
  ...
  async updateStore<T extends TripBai.Stores.Endpoints.UpdateStore>(
    ...
    const commandDTO: Parameters<UpdateStoreCommand["execute"]>[0] = Object.create(null)
