...
export class TourUpdateController {
  ...
  constructor(
    @inject(UpdateTourCommand) public readonly updateTourCommand: UpdateTourCommand
  ) {}
  ...
  async updateTour<T extends TripBai.Tours.Endpoints.UpdateTour>(
    ...
    const commandDTO: Parameters<UpdateTourCommand["execute"]>[0] = Object.create(null)
