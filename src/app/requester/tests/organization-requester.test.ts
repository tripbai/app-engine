...
describe('OrganizationRequester', () => {
  describe('isWebAdmin', () => {
    ...
    it('should return false for regular users', () => {
      ...
      const regularUserPermission = `iauth:users:${userId}` as Core.Authorization.ConcreteToken
      ...
      const organizationRequesterFactory = container.get(OrganizationRequesterFactory)
      const organizationRequester = organizationRequesterFactory.create(requester)
    ...
    it('should return false for organization admins', () => {
      const userId = Pseudorandom.alphanum32()
      const organizationPermissionService = container.get(OrganizationPermissionService)
      const organizationId = Pseudorandom.alphanum32()
      const organizationAdminPermission = organizationPermissionService.createOrganizationLevelPermission(organizationId)
      const requester: Core.Authorization.Requester = {
        ipAddress: '0.0.0.0',
        userAgent: 'test-agent',
        user: {entity_id: userId, status: 'active'},
  ...
  describe('isOrganizationAdminOf', () => {
    ...
    it('should return true for organization admins', () => {
      ...
      const organizationRequesterFactory = container.get(OrganizationRequesterFactory)
      const organizationRequester = organizationRequesterFactory.create(requester)
      expect(organizationRequester.isOrganizationAdminOf(organizationId)).to.be.true
    })
    ...
    it('should return false if the organization ID does not match', () => {
      ...
      const organizationId2 = Pseudorandom.alphanum32()
      const organizationRequesterFactory = container.get(OrganizationRequesterFactory)
      const organizationRequester = organizationRequesterFactory.create(requester)
      expect(organizationRequester.isOrganizationAdminOf(organizationId2)).to.be.false
    })
    ...
    it('should return false for regular users', () => {
      ...
      const organizationRequesterFactory = container.get(OrganizationRequesterFactory)
      const organizationRequester = organizationRequesterFactory.create(requester)
      expect(organizationRequester.isOrganizationAdminOf(Pseudorandom.alphanum32())).to.be.false
    })
    ...
    it('should return true for web admins', () => {
      ...
      const organizationRequesterFactory = container.get(OrganizationRequesterFactory)
      const organizationRequester = organizationRequesterFactory.create(requester)
      expect(organizationRequester.isOrganizationAdminOf(Pseudorandom.alphanum32())).to.be.true
    })
    ...
    it('should return false for requesters with store level permissions', () => {
      ...
      const organizationPermissionService = container.get(OrganizationPermissionService)
      const organizationId = Pseudorandom.alphanum32()
      const storeId = Pseudorandom.alphanum32()
      const storePermission = organizationPermissionService.createStoreLevelPermission({
        storeId,
        organizationId
      })
      const requester: Core.Authorization.Requester = {
      ...
      expect(organizationRequester.isOrganizationAdminOf(organizationId)).to.be.false
  ...
  describe('canOperateStore', () => {
    ...
    it('should return true for organization admins', () => {
      ...
      expect(organizationRequester.canOperateStore({ storeId, organizationId })).to.be.true
    })
    ...
    it('should return false if the organization ID does not match', () => {
      ...
      expect(organizationRequester.canOperateStore({ storeId, organizationId: organizationId2 })).to.be.false
    })
    ...
    it('should return true for web admins', () => {
      ...
      expect(organizationRequester.canOperateStore({ storeId, organizationId: Pseudorandom.alphanum32() })).to.be.true
    })
    ...
    it('should return false for regular users', () => {
      ...
      expect(organizationRequester.canOperateStore({ storeId, organizationId: Pseudorandom.alphanum32() })).to.be.false
    })
    ...
    it('should return false if store ID does not match', () => {
      ...
      const organizationPermissionService = container.get(OrganizationPermissionService)
      const organizationId = Pseudorandom.alphanum32()
      const storeIdPermittedToAccess = Pseudorandom.alphanum32()
      const storePermission = organizationPermissionService.createStoreLevelPermission({
      ...
      const organizationRequesterFactory = container.get(OrganizationRequesterFactory)
      const organizationRequester = organizationRequesterFactory.create(requester)
      const storeIdNotPermittedToAccess = Pseudorandom.alphanum32()
      // This should return false as the store ID does not match
      expect(organizationRequester.canOperateStore({ storeId: storeIdNotPermittedToAccess, organizationId })).to.be.false
    })
