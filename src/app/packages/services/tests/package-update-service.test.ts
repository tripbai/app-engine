...
const existingPackage1Id = Pseudorandom.alphanum32()
...
const existingPackage2Id = Pseudorandom.alphanum32()
...
class TestDatabaseProvider extends TransientMockDatabase {
  protected dataStorage: Map<string, Map<Core.Entity.Id, FlatDatabaseRecord>> = new Map([
    ['packages',exitingRecords]
  ])
}
